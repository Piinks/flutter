...
void main() {
  testWidgets('AnimatedList onVisibleChildrenChanged reports visible children', (
    WidgetTester tester,
  ) async {
      ...
      Directionality(
        ...
        child: AnimatedList(
          ...
          itemBuilder: (BuildContext context, int index, Animation<double> animation) {
            return SizedBox(key: ValueKey<int>(index), height: 100.0, child: Text('Item $index'));
          },
  ...
  testWidgets('AnimatedGrid onVisibleChildrenChanged reports visible children', (
    WidgetTester tester,
  ) async {
    final visibleChildren = <VisibleChildData>[];
    ...
    await tester.pumpWidget(
      Directionality(
        ...
        child: AnimatedGrid(
          ...
          initialItemCount: 20,
          itemBuilder: (BuildContext context, int index, Animation<double> animation) {
            return SizedBox(key: ValueKey<int>(index), child: Text('Item $index'));
          },
          onVisibleChildrenChanged: (Iterable<VisibleChildData> children) {
            visibleChildren.clear();
            visibleChildren.addAll(children);
  ...
  testWidgets('SliverFillViewport onVisibleChildrenChanged reports visible children', (
    WidgetTester tester,
  ) async {
    final visibleChildren = <VisibleChildData>[];
