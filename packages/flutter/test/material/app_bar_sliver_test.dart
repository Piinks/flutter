...
Widget buildSliverAppBarApp({
  ...
  bool snap = false,
  double toolbarHeight = kM2ToolbarHeight,
}) {
  return MaterialApp(
    home: Scaffold(
...
void main() {
  ...
  group('SliverAppBar.forceMaterialTransparency', () {
    ...
    testWidgets('forceMaterialTransparency == false does not allow gestures beneath the app bar', (WidgetTester tester) async {
  ...
  testWidgets('SliverAppBar positioning of leading and trailing widgets with bottom padding', (WidgetTester tester) async {
    ...
    expect(tester.getRect(find.byKey(leadingKey)), const Rect.fromLTRB(800.0 - 56.0, 100.0, 800.0, 100.0 + 64.0));
