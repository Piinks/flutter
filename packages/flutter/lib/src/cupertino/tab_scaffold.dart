...
class _CupertinoTabScaffoldState extends State<CupertinoTabScaffold> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    // Don't double pad.
    if (!widget.resizeToAvoidBottomInset ||
        widget.tabBar.preferredSize.resolve(context).height > existingMediaQuery.viewInsets.bottom) {
      // TODO(xster): Use real size after partial layout instead of preferred size.
      // https://github.com/flutter/flutter/issues/12912
      final double bottomPadding =
          widget.tabBar.preferredSize.resolve(context).height + existingMediaQuery.padding.bottom;
