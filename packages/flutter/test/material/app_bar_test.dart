...
void main() {
  ...
  testWidgets('AppBar dimensions, with and without bottom, primary', (WidgetTester tester) async {
    ...
    expect(appBarHeight(tester), kM2ToolbarHeight);
    ...
    expect(appBarHeight(tester), kM2ToolbarHeight + 100.0);
    ...
    expect(appBarTop(tester), 0.0);
    expect(appBarHeight(tester), kM2ToolbarHeight + 200.0);
    ...
    expect(appBarTop(tester), 0.0);
    expect(appBarHeight(tester), kM2ToolbarHeight + 100.0 + 200.0);
  ...
  testWidgets('AppBar handles loose children 0', (WidgetTester tester) async {
    ...
    expect(tester.renderObject<RenderBox>(find.byKey(key)).size, const Size(56.0, 64.0));
  });
      ...
      MaterialApp(
        home: Center(
          child: AppBar(
            ...
            bottom: PreferredSize(
              preferredSize: const Size(0.0, kM2ToolbarHeight),
              child: Container(
                height: 50.0,
  ...
  group('MaterialStateColor scrolledUnder', () {
    ...
    testWidgets('backgroundColor for horizontal scrolling', (WidgetTester tester) async {
      ...
      expect(tester.getSize(findAppBarMaterial()).height, kM2ToolbarHeight);

      TestGesture gesture = await tester.startGesture(const Offset(50.0, 400.0));
      await gesture.moveBy(const Offset(0.0, -kM2ToolbarHeight));
      await tester.pump();
      await gesture.moveBy(const Offset(0.0, -kM2ToolbarHeight));
      await gesture.up();
      await tester.pumpAndSettle();
      ...
      // Scroll horizontally
      await gesture.moveBy(const Offset(-kM2ToolbarHeight, 0.0));
      await tester.pump();
      await gesture.moveBy(const Offset(-kM2ToolbarHeight, 0.0));
      await gesture.up();
      await tester.pumpAndSettle();
  ...
  testWidgets('AppBar.preferredHeightFor', (WidgetTester tester) async {
    ...
    expect(preferredHeight, kM2ToolbarHeight);
    expect(preferredSize.height, kM2ToolbarHeight);
